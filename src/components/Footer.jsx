...
const Footer = () => {
  return (
    <div  className="w-full  pt-24 pb-10 p-12 bg-zinc-900 ">
      <div className="h-screen flex">
        <div className="w-1/2 h-full flex flex-col justify-between ">
          <div className="headings">
            <h1 className="text-8xl leading-none tracking-[-.08em]  mt-6 -mb-8  font-bold ">
              EYE-
            </h1>
            <h1 className="text-8xl leading-none  mt-2 -mb-8 tracking-[-.08em]  font-bold  ">
              OPENING
            </h1>
          </div>
          <svg
        ...
        <div className="w-1/2 bg-green-600 overflow-hidden h-full">
          <div>
            <h1 className="text-8xl leading-none tracking-[-.08em]  mt-6 -mb-8  font-bold ">
              PRESENTATIONS
            </h1>
